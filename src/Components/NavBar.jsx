...
function ModeToggle() {
    ...
    return (
      <div>
        ...
        startDecorator={mode==='light'? <WbSunnyIcon /> :<BedtimeIcon />}
          color="primary"
          size="lg"
          variant="outlined"
  ...
  return (
    <Box sx={{ minHeight: 190, mx:20 }}>
      ...
      >
        ...
        <ListItem>
            <img src='logo.png' width={136} height={40} alt='CareerSyncLogo'/>
        </ListItem>
        <ListItem role="none">
          <ListItemButton
            role="menuitem"
        ...
        <Grid container spacing={2} columns={2} sx={{ flexGrow: 1 }} justifyContent={'flex-end'} alignContent={'center'}>
        <Grid item container alignItems="center" justify="center"> {/* Added container, alignItems, and justify props */}
            <ListItem>
                <ModeToggle/>
            </ListItem>
            <ListItem>
